...
public class MyAdapterPerfil extends RecyclerView.Adapter<MyAdapterPerfil.ViewHolder> {
    ...
    public void setData(List<String> myDataset) {
        values = myDataset;
    ...
    public MyAdapterPerfil() {
        values = new ArrayList<>();
    }

    // Provide a suitable constructor (depends on the kind of dataset)
    public MyAdapterPerfil(List<String> myDataset) {
        values = myDataset;
    }

    // Create new views (invoked by the layout manager)
    @Override
    public MyAdapterPerfil.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                         int viewType) {
        // create a new view
